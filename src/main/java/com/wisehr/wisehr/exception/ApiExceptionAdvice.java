...
import com.wisehr.wisehr.exception.dto.ApiExceptionDTO;
...
public class ApiExceptionAdvice {
    ...
    * */
    ...
    /* 비밀번호가 같지 않을 때 발생하는 예외 상황 처리 */
    @ExceptionHandler(PasswordNotEqualException.class)
    public ResponseEntity<ApiExceptionDTO> exceptionHandler(PasswordNotEqualException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ApiExceptionDTO(HttpStatus.BAD_REQUEST, e.getMessage()));
    }
}
