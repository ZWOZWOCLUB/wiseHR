...
import com.wisehr.wisehr.setting.dto.SettingMemDepAttSchDTO;
...
//    @Query(
//            "SELECT A.memCode, A.memName, A.depCode, " +
//            "B.attCode, B.attStartTime, B.attEndTime, B.attStatus, B.attWorkDate, B.schCode, " +
//            "D.schType, D.schColor, " +
//            "E.depName " +
...
//    List<Object[]> findByYearMonth(String yearMonth);
    ...
    @Query(
            "SELECT NEW com.wisehr.wisehr.setting.dto.SettingMemDepAttSchDTO(" +
                    "A.memCode, A.memName, A.depCode, " +
                    "B.attCode, B.attStartTime, B.attEndTime, B.attStatus, B.attWorkDate, B.schCode, " +
                    "D.schType, D.schColor, " +
                    "E.depName) " +
                    "FROM SettingMemDepAttSch A " +
                    ...
                    "GROUP BY A.memCode, A.memName, A.depCode, B.attCode, B.attStartTime, B.attEndTime, B.attStatus, B.attWorkDate, B.schCode, D.schType, D.schColor " +
                    "ORDER BY E.depCode")
    List<SettingMemDepAttSchDTO> findByYearMonth(String yearMonth);
